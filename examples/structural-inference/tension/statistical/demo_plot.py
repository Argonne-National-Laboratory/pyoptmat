...
if __name__ == "__main__":
  ...
  names = ["n", "eta", "s0", "R", "d"]
  sampler = optimize.StatisticalModel(make, names, 
  ...
  p = plt.fill_between(data[2,:,0], min_result, max_result, alpha = 0.5,
      color = 'k')

  plt.legend([Line2D([0], [0], color = 'k', ls = '--'),
    Line2D([0],[0], color = 'k', lw = 4),
    Patch(facecolor='k', edgecolor=None, alpha = 0.5)], 
    ["Experimental data", "Model average", "Model 95% prediction interval"], loc = 'best')
