"""
  ...
  In addition, the object needs to define the derivative of the inelastic strain rate and internal variable
  evolution rates with respect to the current values of stress and the current values of the
  internal variables.  The objects return "self" derivatives (i.e. the derivative of the inelastic
  strain rate with respect to stress and the derivative of the internal variable rate with respect
  to the internal variables) along with the rates themselves.  The "cross" derivatives are defined with
  separate methods.
"""
...
class PerfectViscoplasticity(FlowRule):
  ...
  def history_rate(self, s, h, t, T):
    """
      ...
      Returns:
        tuple(torch.tensor, torch.tensor):  the history rate and the derivative of the history rate with
                                            respect to history
    """
